...
> You can also specify a specific release like 'git clone --branch release-0.7.2 https://github.com/keptn-sandbox/keptn-in-a-box.git' the master branch will be pointing to the actual release.
