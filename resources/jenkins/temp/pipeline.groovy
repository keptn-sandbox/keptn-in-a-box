...
node {
    properties([
        parameters([
         ...
         string(defaultValue: 'http://18-130-213-16.nip.io/easytravel/home', description: 'URI of the application you want to run a test against', name: 'DeploymentURI', trim: false),
