...
node {
    ...
    stage('Initialize Keptn') {
        keptn.downloadFile("https://raw.githubusercontent.com/keptn-sandbox/keptn-in-a-box/release-0.8.3/resources/jenkins/pipelines/keptn/shipyard-performance.yaml", 'keptn/shipyard.yaml')
