...
node {
    properties([
        parameters([
         ...
         string(defaultValue: '/:homepage;/easytravel/search?selectedLocation=cancun:Search Cancun;/easytravel/contact:contact;/easytravel/login:login', description: 'A semi-colon separated list of URIPaths:TestName tupples that the load test should generate load', name: 'URLPaths', trim: false),
